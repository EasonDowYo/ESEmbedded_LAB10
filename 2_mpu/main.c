...
void set_mpu(void)
{
	...
	REG(MPU_BASE+MPU_RASR_OFFSET)=MPU_RASR_VALUE( MPU_XN_DISABLE , MPU_AP_FULL_ACCESS , MPU_TYPE_PERIPHERALS , 0 , MPU_REGION_SIZE_32B );
	...
	for (int i=0;i<4;i++)
	{	
		REG(MPU_BASE+MPU_RBAR_OFFSET)=MPU_RBAR_VALUE(0x00000000,i+4);
